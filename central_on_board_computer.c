...
//gcc -o central Systems/lvt_system.c Systems/brake_system.c Systems/motor_system.c Utils/termios_util.c central_on_board_computer.c -lpthread
// ./central
...
extern char binary_motor_system[3]; //Variável para a leitura do código binário Motor
